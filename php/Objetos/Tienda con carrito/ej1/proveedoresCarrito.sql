...
CREATE TABLE PIEZA (
    ...
    NOMPIEZA CHAR(30),
    PRECIOVENT INTEGER,
	 RUTAIMG VARCHAR(100) default 'img/productos/default.jpg'
	 );
...
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT,RUTAIMG) VALUES ('C-400-Z', 'FILTRO PANTALLA 17', 1800,"img/productos/C-400-Z.jpg");
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT,RUTAIMG) VALUES ('DD-0001-210', 'DISCO DURO 20 Gb WD', 25000,"img/productos/DD-0001-210.jpg");
...
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT,RUTAIMG) VALUES ('M-0001-C', 'MONITOR LG 17P', 30000,"img/productos/M-0001-C.jpg");
...
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT,RUTAIMG) VALUES ('2', 'Teclado ErgonOmico', 15000,"img/productos/2.jpg");
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT,RUTAIMG) VALUES ('3', 'Teclado ps/2', 2570,"img/productos/3.jpg");
...
COMMIT WORK;
/*
INSERT INTO USUARIOS VALUES("dani",1234);
INSERT INTO USUARIOS VALUES("pepe",1234);
INSERT INTO USUARIOS VALUES("jesus",1234);
INSERT INTO USUARIOS VALUES("pepa",1234);*/
INSERT INTO USUARIOS (nombre,pass)
SELECT  NUMVEND,TELEFONO
FROM    VENDEDOR;
...
ALTER TABLE INVENTARIO ADD CONSTRAINT CAJ_INVENTARIO_PIEZA FOREIGN KEY (NUMPIEZA) REFERENCES PIEZA (NUMPIEZA);
ALTER TABLE LINPED ADD CONSTRAINT CAJ_LINPED_PEDIDO FOREIGN KEY (NUMPEDIDO) REFERENCES PEDIDO (NUMPEDIDO);
ALTER TABLE LINPED ADD CONSTRAINT CAJ_LINPED_PIEZA FOREIGN KEY (NUMPIEZA) REFERENCES PIEZA (NUMPIEZA);
ALTER TABLE PEDIDO ADD CONSTRAINT CAJ_PEDIDO_VENDEDOR FOREIGN KEY (NUMVEND) REFERENCES VENDEDOR (NUMVEND);
ALTER TABLE PRECIOSUM ADD CONSTRAINT CA_PIEZA_PRECIOSUM FOREIGN KEY (NUMPIEZA) REFERENCES PIEZA (NUMPIEZA);
