drop database if exists proveedores2;
...
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('A-1001-L', 'RATON NEGRO 3BOTONES', 300);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('C-1002-H', NULL, 400);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('C-1002-J', NULL, 700);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('C-400-Z', 'FILTRO PANTALLA 17', 1800);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('DD-0001-210', 'DISCO DURO 20 Gb WD', 25000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('DD-0001-30', 'DISCO DURO 20 Gb SEAGATE', 20000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('DK144-0002-P', 'CAJA DISCOS 1.44Mb', 1100);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('DK720-0002-P', 'CAJA DISCOS 720Mb', 1500);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('FD-0001-144', 'UNIDAD DISCO 1.44 SAMSUNG', 15000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('FD-0002-720', 'UNIDAD DISCO 720 SAMSUNG', 17000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('M-0001-C', 'MONITOR LG 17P', 30000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('M-0003-C', 'MONITOR SONY 17P', 45000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('O-0001-PP', 'PEGATINAS ESPECIALES FD 1.44', 400);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('O-0002-PP', 'PEGATINAS ESPECIALES FD 720', 450);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('P-0001-33', 'PLACA BASE SOLTEK 33Mhz', 25000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('P-0002-533', 'PLACA BASE INTEL', 75000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('T-0001-AT', 'TECLADO COMPATIBLE AT', 1000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('T-0001-IBM', 'TECLADO COMPATIBLE IBM', 1500);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('T-0002-AT', 'TECLADO COMPATIBLE AT2', 1045);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('2', 'Teclado ErgonOmico', 15000);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('3', 'Teclado ps/2', 2570);
INSERT INTO PIEZA (NUMPIEZA, NOMPIEZA, PRECIOVENT) VALUES ('4', 'RatOn ps/2', 1500);
...
ALTER TABLE PRECIOSUM ADD CONSTRAINT CA_PIEZA_PRECIOSUM FOREIGN KEY (NUMPIEZA) REFERENCES PIEZA (NUMPIEZA) ON DELETE RESTRICT  ON UPDATE CASCADE;
ALTER TABLE PRECIOSUM ADD CONSTRAINT CA_VENDEDOR_PRECIOSUM FOREIGN KEY (NUMVEND) REFERENCES VENDEDOR (NUMVEND) ON DELETE RESTRICT  ON UPDATE CASCADE;

ALTER TABLE PEDIDO ADD CONSTRAINT CAJ_PEDIDO_VENDEDOR FOREIGN KEY (NUMVEND) REFERENCES VENDEDOR (NUMVEND) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE LINPED ADD CONSTRAINT CAJ_LINPED_PEDIDO FOREIGN KEY (NUMPEDIDO) REFERENCES PEDIDO (NUMPEDIDO) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE LINPED ADD CONSTRAINT CAJ_LINPED_PIEZA FOREIGN KEY (NUMPIEZA) REFERENCES PIEZA (NUMPIEZA) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE INVENTARIO ADD CONSTRAINT CAJ_INVENTARIO_PIEZA FOREIGN KEY (NUMPIEZA) REFERENCES PIEZA (NUMPIEZA) ON DELETE CASCADE ON UPDATE RESTRICT;