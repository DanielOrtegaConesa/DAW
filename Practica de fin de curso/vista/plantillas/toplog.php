...
<head>
    ...
    <link rel="StyleSheet" href="vista/estilo/css/comun.css" type="text/css" MEDIA=all>
        ...
        <nav>
            <div class="nav-wrapper ">
                <ul id="nav-mobile" class="left">
                    <li><a href="https://github.com/DanielOrtegaConesa/Trabajo-Final-Daw" class="brand-logo right flex h100"><img src="vista/img/logo2.png"
                                                                            class="milogo"></a></li>
                    <li><a href="#" data-activates="slide-out" id="disparadorlateral"><i class="material-icons">menu</i></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <ul id="slide-out" class="side-nav">
            <li>
                <div class="user-view text">
                    ...
                    <span  class="white-text"><img id="imgperfil" class="waves-circle" src="<?= $usesion->getImg() ?>"> <a href="index.php?page=editarUsuario"><i class="small material-icons white-text">settings</i></a></span>
