function callbackVerCarrito(datos) {
    ...
    for (let c in datos.resultados) {
        $("#tb").append(
            ...
            "<td> <a class='btn-floating btn-large waves-effect waves-light deep-purple lighten-1' id='" + resultados[c]["codArticulo"] + "Eliminar'><i class='material-icons'>close</i></a></td>" +
            "</tr>"
        );
