function callbackListar(datos) {
    ...
    for (let c in datos.resultados) {
        ...
        let borrar = "<td>   <a class='btn-floating btn-large waves-effect waves-light deep-purple lighten-1' id='" + resultados[c]["codPedido"] + "Ver'><i class='material-icons'>open_in_new</i></a> </td>";
        if (resultados[c]["borrable"]) {
            borrar =
                "<td>" +
                "   <a class='btn-floating btn-large waves-effect waves-light deep-purple lighten-1' id='" + resultados[c]["codPedido"] + "Ver'><i class='material-icons'>open_in_new</i></a>" +
                "   <a class='btn-floating btn-large waves-effect waves-light deep-purple lighten-1' id='" + resultados[c]["codPedido"] + "Borrar'><i class='material-icons'>delete</i></a>" +
                "<td/>";
        }
