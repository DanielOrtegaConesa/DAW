  ...
  //  console.log(datos);
    ...
    for (let c in datos.resultados) {
        ...
        if (resultados[c]["mye"]) {
            mye =
                "<td>" +
                "   <a class='btn-floating btn-large waves-effect waves-light blue lighten-1' id='" + resultados[c]["codPedido"] + resultados[c]["numLineaPedido"] + "Borrar'><i class='material-icons'>delete</i></a>" +
                "   <a class='btn-floating btn-large waves-effect waves-light blue lighten-1' id='" + resultados[c]["codPedido"] + resultados[c]["numLineaPedido"] + "Editar'><i class='material-icons'>mode_edit</i></a>" +
                "<td/>";
        }
